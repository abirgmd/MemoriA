...
public class UserService {
    ...
    public List<User> getActiveUsersByRole(String role) {
        return userRepository.findByRoleAndActif(role.toUpperCase(), true);
    }

    public List<User> getUsersByRoleAndDisponibiliteStatus(String role) {
        return userRepository.findByRoleAndDisponibiliteStatut(role.toUpperCase(), StatutDisponibilite.LIBRE);
    }
